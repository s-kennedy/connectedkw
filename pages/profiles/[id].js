...
<section className="bg-slate-100 w-full flex flex-col ">
      <div className="p-8">
        <button
          onClick={() => router.push("/profiles")}
          className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow cursor-pointer w-12 h-12 flex items-center justify-center rounded-full"
        >
          <i className="fa-solid fa-arrow-left"></i>
        </button>
        </div>
    <div className="bg-slate-100 md:py-12 pt-12 pb-12 w-full flex flex-col items-center">
