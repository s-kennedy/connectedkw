  ...
  return (
    <Layout title="Summer camps 2024" description="Discover the summer camp options in KW" color="yellow">
      <div className="container py-5 mx-auto">
        ...
        >
          <div className="py-3">
            <p>The Christmas lights are still up, but it's already time to start thinking about summer camps 😑</p>
            ...
            <p>You can filter for the ones that are currently open for registration, or browse the calendar view (to see registration dates) or map view to see the camp locations.</p>
          </div>
        </EventsFeed>
      </div>
    </Layout>
