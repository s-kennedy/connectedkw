...
const endpoint = `https://api.apify.com/v2/actor-tasks/unboringkw~city-of-waterloo-events/runs/last/dataset/items?token=apify_api_HdIllAbdTTtBnGiFp43mp0wXn2ckSU2N1T2E`
...
Deno.serve(async (req) => {
  ...
  const data = {
    result,
    message: `Scraping City of Waterloo events: ${result?.created?.length} created, ${result?.failed?.length} failed`,
  }
